...
This module is designed to populate the mailing jobs database for sourceforge.net.
        ...
        try:
            ...
            try:
                ...
                for project in projects_list[0:50]:
                    ...
                    try:
                        insert='''INSERT INTO sf_mailing_jobs (unixname,datasource_id,status,last_modified,modified_by)
                        VALUES(%s,%s,'gathering_mailinglists',NOW(),%s)'''
